...
// 2018-1-30
const MemberData = _import('member/memberData');
...
const constantRouterMap = [
...

  {
    path: '/',
    //component: Layout,
    redirect: '/index/dashboard',  //重定向到默认首页
  ...
  //2018-1-30
  {
    ...
    name: '',
    children: [
      { path: 'dashboard', component: FinancialEchart, name: '仪表盘' } 
    ]
  },
  {
    path: '/member',
    ...
    name: '会员系统',
    children: [
      { path: 'memberData', component: MemberData, name: '会员资料' } 
    ]
  },
