        ...
        <template v-if="routes">
           ...
           <!--  <router-link  to="/index/readme"  v-if="routes['/index/readme']" >
            ...
            <el-submenu index="数据管理" > 
                <template slot="title">
                    <i class="fa fa-address-card-o" aria-hidden="true"></i> 会员系统
                </template>
                    ...
                    <router-link  class="menu-indent" to="/member/memberData" >
                        <el-menu-item index="/member/memberData">
                            会员资料
                        </el-menu-item>
                    </router-link>
                    <router-link  class="menu-indent" to="/member/deposit" >
                        <el-menu-item index="/member/financialList">
                            存款会员
                        </el-menu-item>
                    </router-link>
                    <router-link  class="menu-indent" to="/member/noDeposit" >
                        <el-menu-item index="/member/financialList">
                            出款会员
                        </el-menu-item>
                    </router-link>
